		...
		<Layout title="Política de privacidad">
			...
			<div className='py-section container'>
				<div className='space-y-6'>
					<div >
						<h5 className='font-medium'>Recolección y uso de la información.</h5>
						<p className='mt-2'>
						La política de Privacidad y Seguridad de Brinca Este Jumping Park aplica a la recopilación y uso de la información que usted nos suministre a través de nuestro Sitio Web, dicha información será utilizada únicamente por la Brinca Este Jumping Park en el cumplimiento de sus fines.
						</p>
						<p>
					...
					<div>
						<h5 className='font-medium'>Cookies.</h5>
						<p className='mt-2'>
					...
					<div>
						<h5 className='font-medium'>Seguridad de la información</h5>
						<p className='mt-2'>
					...
					<div>
						<h5 className='font-medium'>Actualización de datos</h5>
						<p className='mt-2'>
					...
					<div>
						<h5 className='font-medium'>Actualización de políticas</h5>
						<p className='mt-2'>
					...
					<div>
						<h5 className='font-medium'>Contáctenos</h5>
						<p className='mt-2'>
						Brinca Este Jumping Park está comprometido en proteger los datos que usted nos proporcione. Si tiene alguna pregunta, observación o inquietud sobre nuestra Política de Privacidad y Seguridad o nuestros Términos y Condiciones, póngase en contacto con nosotros enviándonos un mensaje de correo electrónico a brincaeste@gmail.com
						</p>
					</div>
