		...
		<div className="container ">
			<div className="bg-gradient-invert relative mt-4 rounded py-8 px-4  lg:py-10 lg:px-7">
				<div className="items-center justify-between px-3 md:flex lg:px-0">
					<div>
						<p className="font-medium uppercase text-blue-400 md:text-lg">
							BIENVENIDOS A{" "}
						...
						<form onSubmit={handleSubmit}>
							<div className="relative flex flex-col items-stretch justify-between gap-5 lg:grid-cols-12 lg:flex-row lg:items-center ">
								...
								<Flatpickr
									placeholder="Fecha"
									required={true}
									className="w-36 border-r-0 border-l-0 border-t-0 border-b border-white border-opacity-70 bg-inherit ring-0 focus:border-primary-500 focus:ring-0"
									name="search"
									options={{
										locale: Spanish,
									}}
