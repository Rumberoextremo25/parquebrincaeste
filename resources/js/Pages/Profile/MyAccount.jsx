            ...
            <div className="container py-section">
                <div className="grid grid-cols-12 md:gap-4 gap-y-10">
                    <div className="col-span-12 md:col-span-3">
                                ...
                                <Link
                                    ...
                                    className={
                                        ...
                                        (route().current(item.path)
                                            ...
                                            : "border-primary-100  hover:border-blue-500 hover:text-blue-500")
                                    }
                                >
                                    {item.name}
                                </Link>
                        ...
                        <div className="mt-6">
                            <button
                                className="uppercase font-bold rounded  text-blue-500 border border-blue-500 text-sm py-2 px-4 hover:bg-blue-500 hover:text-white disabled:opacity-25 leading-none"
