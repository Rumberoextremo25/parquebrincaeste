...
const Filters = ({ events, filters }) => {
    ...
    return (
        <Layout title="Eventos">
            <BannerHero title=" CONSIGUE TUS ENTRADAS Y VIVE LA EXPERIENCIA EN BRINCA ESTE"
                desc="Emisión de boletos segura y confiable. ¡Su boleto para entretenimiento!" img="/img/home/BrincaEste.jpg" />
            {/* <BannerHero
                img="/img/movies.jpg"
